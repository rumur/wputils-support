...
namespace Rumur\WPUtils\Support;

use Rumur\WPUtils\Contracts\Scheduling\Job;
use Rumur\WPUtils\Foundation\Application;
...
if (!function_exists('app')) {
     ...
     * @param array $value
     *
     * @return mixed|\Rumur\WPUtils\Foundation\Application
     */
...
if (!function_exists('config')) {
     ...
     * @param mixed $default
     *
     * @return mixed|\Rumur\WPUtils\Config\Repository
     */
...
if (!function_exists('schedule')) {
     ...
     *
     * @param Job $job
     * @return \Rumur\WPUtils\Scheduling\Scheduler
     */
...
if (!function_exists('view')) {
     ...
     * @param string $view
     * @param array $data
     * @return \Rumur\WPUtils\Contracts\View\View|\Rumur\WPUtils\Contracts\View\Factory
     */
